...
- **`bai_giang` chỉ là nội dung/giáo án, không phải lịch**: tên bài, chuyên đề, số tiết — **không** thêm thời gian, giảng viên/trợ giảng chỉ định, hay tiến độ đăng ký vào bảng này dù nghe hợp lý về UX. Các thông tin đó thuộc `dang_ky_giang_day` (đăng ký + duyệt) và `lich_giang` (thời gian + người dạy đã xác nhận) — 2 bảng này đã có sẵn từ Giai đoạn 1 đúng cho mục đích đó, lắp vào 2 tab "Đăng ký & Duyệt"/"Lịch giảng" trong trang chi tiết lớp thay vì gộp vào tab "Bài giảng" (quyết định chốt 2026-09-10, xem tientrinh.md Giai đoạn 4 mục 7).
